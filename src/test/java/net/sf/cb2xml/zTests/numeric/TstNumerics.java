...
public class TstNumerics {
	...
	public void testDecimal() throws XMLStreamException, LexerException, IOException, ParserException {
		...
		for (int i = 0; i < itemTree.size(); i++) {
			assertEquals(i, items.get(i).getScale(), "" + i);
			assertEquals(i+1, items.get(i).getStorageLength(), "" + i);
			assertEquals(i+1, items.get(i).getDisplayLength(), "" + i);
		}
	...
	public void testNumeric() throws XMLStreamException, LexerException, IOException, ParserException {
		...
		for (int i = 0; i < itemTree.size(); i++) {
			assertEquals(2, items.get(i).getScale(), "" + i);
			assertEquals(i+3, items.get(i).getStorageLength(), "" + i);
			assertEquals(i+3, items.get(i).getDisplayLength(), "" + i);
		}
